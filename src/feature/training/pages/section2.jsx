...
import { Link } from "react-router-dom"
 export default function Section2() {
  ...
  <div className="w-100 h-100 d-flex flex-wrap gap-5 ">
           ...
           <div className=" w-100 h-110  d-flex  justify-content-evenly flex-wrap gap-2 pt-3 ">
            <h1 className="w-100 text-center text-white mb-3">online coach</h1>
                <div className=" w-45 h-75 bg-secondary rounded-4  flex-wrap d-flex align-items-center text-white text-center  justify-content-center p-2">
                ...
                <div className="w-45 h-75 bg-primary rounded-4 flex-wrap d-flex align-items-center text-white text-center  justify-content-center p-2">
                ...
                <div className="w-45 h-75 bg-warning rounded-4 flex-wrap d-flex align-items-center text-white text-center  justify-content-center p-2">
           ...
           <div className=" w-100 h-100  d-flex  justify-content-evenly flex-wrap gap-2 py-5  "> 
             <h1 className="w-100 text-center text-white mb-3">private coach</h1>
                <div className="w-45 h-111 bg-secondary rounded-4 flex-wrap d-flex align-items-center text-white text-center  justify-content-center">
                <h1 className="w-100 h-25 border-bottom border-white pt-4 text-uppercase fw-bold"> standard</h1>
                ...
                <div className="w-45 h-111 bg-primary rounded-4 flex-wrap d-flex align-items-center text-white text-center  justify-content-center ">
                <h1 className="w-100 h-25 border-bottom border-white pt-4 text-uppercase fw-bold">  premium</h1>
                ...
                <div className="w-45 h-111 bg-warning rounded-4 flex-wrap d-flex align-items-center text-white text-center  justify-content-center">
                <h1 className="w-100 h-25 border-bottom border-white pt-4 text-uppercase fw-bold"> vip</h1>
