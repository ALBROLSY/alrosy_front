import { prsonaldata } from "../../../services/personaldata";
      ...
      const navigate = useNavigate();
       useEffect(()=>{
          const fatchUserData = async()=>{
             ...
             try{
                const data = await prsonaldata.getUser();
    ...
    return(
       <section className="d-flex justify-content-center align-items-center pt-5 bg-black gap-4 ">
         <div className="w-75 h-100  mb-3 p-2 rounded-5 d-flex flex-wrap justify-content-center" >
            ...
            <div className="w-75 h-100 bg-form d-flex flex-wrap rounded-5 mt-5 ">
            <h1 className="  w-100  text-center text-white fw-bold pb-3 border-bottom ">بيانات المتدرب</h1>
                  <div className="w-50 h-100 p-1 d-flex justify-content-center"><img src={profile?.profile_picture} loading="lazy" alt="الصوره بتاعتك مش وقتك دلوقتى "  className="w-75 h-102 rounded-4"/></div>
            ...
            <div className=" w-75 h-100 bg- d-flex flex-wrap justify-content-center pt-2 bg-form  mt-3 rounded-5 ">
