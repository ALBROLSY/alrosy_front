            ...
            <>
                 <nav>
                        <div className='w-25 h-100 d-flex align-items-center p-1 gap-1'>
                              <img src='src/assets/image/IMG-20260120-WA0006.jpg' alt='' className='w-25 h-100 rounded-circle' />
                        ...
                        <div className=' w-50 h-100 ps-5'>
                            <table>
                                <ul className='  w-100 h-100  d-flex  justify-content-evenly pt-2 me-4 '>
